...
const content = {
  ar: {
    ...
    vehicles: [
      ...
      { id: "drone", odd : false , color: "maroon", title: "طائرات مسيّرة", tag: "قادم قريباً", desc: "توسيع نطاق التغطية للمناطق النائية وتحقيق سرعة توصيل غير مسبوقة.", features: ["وصول للمناطق النائية", "سرعة توصيل فائقة", "تقنية مستقبلية", "قيد التطوير"] },
    ],
    tech: {
      title: "تقنية الأسطول",
