...
function SectorIcon({ type, color }: { type: string; color: string }) {
  const cls = `w-7 h-7`;
  if (type === "finance") return <svg className={cls} style={{ color }} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>;
  if (type === "logistics") return <svg className={cls} style={{ color }} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M8 17H6a2 2 0 01-2-2V7a2 2 0 012-2h10a2 2 0 012 2v3m-4 7h-4m4 0a2 2 0 104 0 2 2 0 00-4 0zm-4 0a2 2 0 11-4 0 2 2 0 014 0zM16 9h4l2 4v2h-6V9z" /></svg>;
  return <svg className={cls} style={{ color }} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z" /></svg>;
}
...
export default function CEOPage() {
  ...
  return (
    <div dir={isAr ? "rtl" : "ltr"} className="overflow-x-hidden bg-white">
      <style>{`
      ...
      <section className="relative bg-white overflow-hidden pt-20 pb-28 md:pt-28 md:pb-36" ref={heroIn.ref}>
        ...
        <div className="absolute inset-0 pointer-events-none" style={{
          ...
          backgroundSize: "60px 60px", animation: "ceo-gridmov 14s linear infinite", opacity: 0.4,
        }}/>
        ...
        <div className="absolute pointer-events-none" style={{
          ...
          background: `radial-gradient(circle at 60% 40%,${M}12 0%,${M}05 40%,transparent 70%)`,
          border: `1.5px solid ${M}15`,
        }}/>
        <div className="absolute pointer-events-none" style={{
          width: 320, height: 320, borderRadius: "50%",
          top: -90, [isAr ? "left" : "right"]: -50,
        ...
        <div className="absolute pointer-events-none" style={{
          ...
          background: `radial-gradient(circle,${G}09 0%,transparent 65%)`,
          border: `1.5px solid ${G}10`,
        }}/>
          ...
          <div className="grid md:grid-cols-2 gap-14 items-center">
            ...
            <div>
              {heroIn.visible && <>
                ...
                {/* Name — words slide in sequentially */}
                <h1 className="text-4xl md:text-[2.8rem] font-black leading-[1.1] tracking-tight mb-4">
                  {t.hero.name.split(" ").map((w, i) => (
                    <span key={i} className="inline-block me-2" style={a("ceo-vanin", 0.12 + i * 0.06, 0.62)}>
                      <span style={{ color: i % 3 === 1 ? M : "#1a0a0e" }}>{w}</span>
                    </span>
                  ))}
                </h1>
                ...
                {/* Summary */}
                <p className="text-[#3a1a1e]/65 text-base leading-relaxed mb-10 max-w-md" style={a("ceo-fadeup", 0.5, 0.65)}>
                  {t.hero.summary}
                </p>
                ...
                <div className="flex flex-wrap gap-8 pt-7 border-t" style={{ borderColor: `${M}15`, ...a("ceo-fadeup", 0.6, 0.65) }}>
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-xs text-gray-400 mt-0.5 font-semibold tracking-widest uppercase">{t.hero.exp.label}</span>
                  </div>
                  {/* Education */}
                  <div className="flex flex-col max-w-xs">
                    <span className="text-xs font-black tracking-widest uppercase mb-1" style={{ color: G }}>{t.hero.edu.label}</span>
                    <span className="text-sm font-bold" style={{ color: "#1a0a0e" }}>{t.hero.edu.value}</span>
                    <span className="text-xs text-gray-400">{t.hero.edu.school}</span>
                  </div>
                </div>
                ...
                <div className="flex flex-wrap gap-2 mt-6" style={a("ceo-fadeup", 0.7, 0.65)}>
                  ...
                  {t.hero.presence.countries.map((c, i) => (
                    <span key={c} className="text-xs font-bold px-3 py-1.5 rounded-full" style={{ background: i % 2 === 0 ? `${G}10` : `${M}10`, color: i % 2 === 0 ? G : M, border: `1px solid ${i % 2 === 0 ? G : M}20` }}>
                      {c}
                    </span>
                  ))}
                </div>
            ...
            <div className="relative hidden md:flex justify-center" style={heroIn.visible ? a("ceo-scalein", 0.1, 0.85) : { opacity: 0 }}>
              ...
              <div className="absolute -top-6 -end-6 w-14 h-14 rounded-full border-2 flex items-center justify-center"
                style={{ borderColor: `${M}35`, animation: "ceo-float 5s ease-in-out infinite" }}>
              ...
              <div className="absolute -bottom-4 -start-4 w-10 h-10 rounded-full border-2"
                style={{ borderColor: `${G}30`, animation: "ceo-float 7s ease-in-out infinite reverse" }}/>
      ...
      {/* ══════════════════════ CHAIRMAN'S QUOTE ══════════════════════ */}
      <section className="py-24 relative overflow-hidden" ref={quoteIn.ref}
        style={{ background: `linear-gradient(150deg,${M} 0%,#5c0f1b 60%,#3a0510 100%)` }}>
        ...
        {/* Big geometric half circle */}
        <div className="absolute pointer-events-none" style={{
          width: 400, height: 400, borderRadius: "50%",
          top: -160, [isAr ? "right" : "left"]: -80,
          ...
          {quoteIn.visible && (
            <>
              <div className="mb-8" style={a("ceo-fadeup", 0, 0.6)}>
                <span className="ceo-badge bg-white/12 text-white/80">
      ...
      {/* ══════════════════════ STRATEGIC PORTFOLIO ══════════════════════ */}
      <section className="py-24 relative overflow-hidden" ref={portIn.ref}
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          {portIn.visible && (
            <div className="text-center mb-16" style={a("ceo-fadeup", 0, 0.6)}>
              ...
              <h2 className="text-4xl md:text-5xl font-black mt-5 tracking-tight" style={{ color: "#1a0a0e" }}>{t.portfolio.title}</h2>
            </div>
          )}
              ...
              return (
                <TiltCard key={sector.title} glowColor={ac}
                  ...
                  style={{
                    background: "#fff",
                    borderColor: `${ac}18`,
                    ...(portIn.visible ? a(animName, 0.1 + si * 0.12, 0.75) : { opacity: 0 }),
                  }}>
                  {/* Corner glow */}
                  <div className="absolute top-0 start-0 w-32 h-32 pointer-events-none" style={{ background: `radial-gradient(circle at 0% 0%,${ac}12 0%,transparent 70%)` }}/>
                  {/* Color top strip */}
                  ...
                  <div className="flex items-center gap-4 mb-7 relative">
                    <div className="w-14 h-14 rounded-2xl flex items-center justify-center relative" style={{ background: `${ac}10` }}>
                    ...
                    <h3 className="text-xl font-black" style={{ color: "#1a0a0e" }}>{sector.title}</h3>
                  </div>

                  {/* Companies grid */}
                  <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 relative">
                    {sector.companies.map((co, ci) => (
                      <div key={co.name}
                        ...
                        onMouseEnter={e => { (e.currentTarget as HTMLElement).style.borderColor = ac + "35"; (e.currentTarget as HTMLElement).style.boxShadow = `0 8px 24px -6px ${ac}18`; }}
                        onMouseLeave={e => { (e.currentTarget as HTMLElement).style.borderColor = ac + "15"; (e.currentTarget as HTMLElement).style.boxShadow = ""; }}
                      >
                        ...
                        <p className="text-[10px] font-bold tracking-wide mb-2" style={{ color: `${ac}70` }}>{co.loc}</p>
                        <p className="text-gray-500 text-xs leading-relaxed">{co.desc}</p>
                      </div>
                    ))}
                  </div>
                </TiltCard>
      ...
      {/* ══════════════════════ COMPETENCIES ══════════════════════ */}
      <section className="bg-white py-24 relative overflow-hidden" ref={compIn.ref}>
        {/* Diagonal stripe */}
        <div className="absolute inset-0 pointer-events-none" style={{
        ...
        {/* Center glow */}
        <div className="absolute inset-0 pointer-events-none" style={{ background: `radial-gradient(ellipse at 50% 50%,${M}04 0%,transparent 65%)` }}/>

        <div className="relative max-w-7xl mx-auto px-6">
          {compIn.visible && (
            <div className="text-center mb-14" style={a("ceo-fadeup", 0, 0.6)}>
              <span className="ceo-badge" style={{ background: `${G}10`, color: G }}>
                <span className="w-1.5 h-1.5 rounded-full" style={{ background: G }}/>
                {t.competencies.badge}
              </span>
              <h2 className="text-4xl md:text-5xl font-black mt-5 tracking-tight" style={{ color: "#1a0a0e" }}>{t.competencies.title}</h2>
            </div>
          )}
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {t.competencies.items.map((item, i) => {
              ...
              return (
                ...
                >
                  {/* Glow orb */}
                  <div className="absolute -top-5 -end-5 w-20 h-20 rounded-full pointer-events-none" style={{ background: `radial-gradient(circle,${ac}15 0%,transparent 70%)`, filter: "blur(8px)" }}/>
                  {/* Icon */}
                  ...
                  <div className="text-[10px] font-black tracking-[.2em] mb-3" style={{ color: `${ac}50` }}>0{i + 1}</div>
      ...
      {/* ══════════════════════ CONTACT ══════════════════════ */}
      <section className="py-24 relative overflow-hidden" ref={contactIn.ref}
        style={{ background: `linear-gradient(150deg,#f0f9f3 0%,#fdf3f4 50%,#f0f9f3 100%)` }}>

        {/* Bg circles */}
        <div className="absolute pointer-events-none" style={{ width: 400, height: 400, borderRadius: "50%", top: -120, [isAr ? "left" : "right"]: -100, background: `radial-gradient(circle,${M}09 0%,transparent 65%)`, border: `1px solid ${M}10` }}/>
        <div className="absolute pointer-events-none" style={{ width: 300, height: 300, borderRadius: "50%", bottom: -80, [isAr ? "right" : "left"]: -60, background: `radial-gradient(circle,${G}08 0%,transparent 65%)`, border: `1px solid ${G}10` }}/>
        ...
        <div className="relative max-w-4xl mx-auto px-6">
          {contactIn.visible && (
            <div className="text-center mb-12" style={a("ceo-fadeup", 0, 0.6)}>
              ...
              <h2 className="text-3xl md:text-4xl font-black mt-5 tracking-tight" style={{ color: "#1a0a0e" }}>{t.contact.title}</h2>
            </div>
          )}
              ...
              return (
                <TiltCard key={item.label} glowColor={ac}
                  ...
                  style={{
                    background: "#fff",
                    borderColor: `${ac}18`,
                    ...(contactIn.visible ? a("ceo-rotatein", 0.1 + i * 0.1, 0.68) : { opacity: 0 }),
                  }}>
                  <div className="w-12 h-12 rounded-xl flex items-center justify-center mx-auto mb-4" style={{ background: `${ac}10` }}>
                    {item.icon === "phone"
                  ...
                  <p className="text-[10px] font-black tracking-widest uppercase mb-2" style={{ color: `${ac}70` }}>{item.label}</p>
                  <p className="font-black text-sm" style={{ color: "#1a0a0e" }} dir="ltr">{item.value}</p>
                  {/* Bottom shimmer */}
          ...
          {contactIn.visible && (
            <div className="text-center" style={a("ceo-fadeup", 0.5, 0.6)}>
              <Link href="/contact"
                ...
                {t.contact.cta}
                <svg className={`w-5 h-5 ${isAr ? "rotate-180" : ""}`} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M14 5l7 7-7 7"/></svg>
              </Link>
            </div>
          )}
        </div>
