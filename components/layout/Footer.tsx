...
const content = {
  ar: {
    ...
    contact: {
      ...
      email: "info@qexpress-sy.com",
      phone: "+963 11 333 3288",
      phone2: "+963 11 333 1544",
      phone3: "+963 11 9290 ",
    },
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex flex-col gap-1" dir="ltr">
                  <a href={`tel:${t.contact.phone}`} className="text-gray-400 hover:text-white text-sm transition-colors">
                    {t.contact.phone}
                  </a>
                  <a href={`tel:${t.contact.phone2}`} className="text-gray-400 hover:text-white text-sm transition-colors">
                    {t.contact.phone2}
                  </a>
                  <a href={`tel:${t.contact.phone3}`} className="text-gray-400 hover:text-white text-sm transition-colors">
                    {t.contact.phone3}
                  </a>
              </div>
