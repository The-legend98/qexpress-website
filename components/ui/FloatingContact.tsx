  ...
  return (
    <div className={`fixed bottom-6 z-50 flex flex-col items-center gap-3 ${isAr ? "left-4" : "right-4"}`}>
      ...
      >
        ...
        <span className={`absolute ${isAr ? "right-14" : "left-14"} whitespace-nowrap text-xs font-semibold text-white bg-[#25D366] px-3 py-1.5 rounded-xl opacity-0 group-hover:opacity-100 transition-all duration-200 shadow-lg pointer-events-none`}>
          WhatsApp
        </span>
      </button>
      ...
      >
        ...
        <span className={`absolute ${isAr ? "right-14" : "left-14"} whitespace-nowrap text-xs font-semibold text-white bg-[#1a5c2a] px-3 py-1.5 rounded-xl opacity-0 group-hover:opacity-100 transition-all duration-200 shadow-lg pointer-events-none`}>
